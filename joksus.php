<?php
    echo ("===========================\n");
        echo ("  GOLEK VOUCHER GOFUD                 \n");
        echo ("  ORA PROMO ORA MADANG :D             \n");
        echo "  JOKO BUJANK                         \n";
        echo "  WAKTU    : ".date('{d-m-Y} ')." \n";
        echo "===========================\n";
